...
public class AolSource extends SearchSource {

	public AolSource(Context context) {
		super(context);
	}
	...
	public String getSearchUrl(String keyWord) {
		String url = null;
		try {
			url = mContext.getResources().getString(ResourceUtil.getStringId(mContext, "ssearch_aol_base"),
