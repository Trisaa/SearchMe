...
public class YahooSource extends SearchSource {

	public YahooSource(Context context) {
		super(context);
	}

	@Override
	public String getSearchUrl(String keyWord) {
		String url = mContext.getResources().getString(ResourceUtil.getStringId(mContext, "ssearch_yahoo_base"), keyWord);
		return url;
	}
